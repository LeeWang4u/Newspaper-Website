...
document.addEventListener('DOMContentLoaded', function () {
    ...
    toggleButton.onclick = function () {
        toggleList.style.display = toggleList.style.display === 'none' ? 'block' : 'none';
    };

    // Function to close the toggle list if clicked outside of it
    document.addEventListener('click', function (event) {
        let isClickInsideElement = toggleButton.contains(event.target) || toggleList.contains(event.target);
